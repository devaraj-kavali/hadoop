...
/**
 * <p>
 * <code>Resource</code> models a set of computer resources in the cluster.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Typically, applications request <code>Resource</code> of suitable capability
 * to run their component tasks.
 * </p>
 * 
 * @see ResourceRequest
...
public abstract class Resource implements Comparable<Resource> {
  ...
  /**
   * This method is DEPRECATED: Use {@link Resource#getMemorySize()} instead
   *
   ...
   * saturate, i.e. the average number of threads it expects to have runnable at
   * a time.
   * 
  ...
  public int hashCode() {
    ...
    int result = (int) (939769357 + getMemorySize()); // prime * result =
                                                      // 939769357 initially
